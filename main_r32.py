...
# Create 2x2 subplot for comparing original and log-transformed price regression outcomes
fig, axes = plt.subplots(2, 2, figsize=(14, 12))

# Scatter plot of actual vs. predicted prices (original)
...
# Scatter plot of residuals vs. predicted prices (original)
axes[0, 1].scatter(y_train_pred, residuals, alpha=0.5)
...
axes[1, 0].scatter(y_train_log, y_train_log_pred, alpha=0.5)
...
axes[1, 1].scatter(y_train_log_pred, residuals_log, alpha=0.5)
...
plt.tight_layout()
plt.savefig(r'C:\Users\Siris\Desktop\GitHub Projects 100 Days NewB\_24_0085__Day81_Predicting_House_Prices_Capstone_Proj__240902\NewProject\comparison_regression_outcomes.png')
